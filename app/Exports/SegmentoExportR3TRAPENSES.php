...
class SegmentoExportR3TRAPENSES implements FromView, ShouldAutoSize, WithHeadings
{
    use Exportable;
    ...
    public function view(): View
    {
        ...
        if($seleccion == 3){
            $nombre = "Patios de comidas";
        }

            $datosSegmentoEntrada = DB::connection('mysql_4')->table('datos_seg_historicos_r3')
