...
class SegmentoExportPANORAMICO implements FromView, ShouldAutoSize, WithHeadings
{
    use Exportable;
    ...
    public function view(): View
    {
        ...
        $idmall = auth()->user()->id_mall;
            ...
            $datosSegmentoEntrada = DB::connection('mysql_5')->table('datos_seg_historicos_r1')
        ...
        return view('layouts.buscar.excel', compact('datosSegmentoEntrada', 'date', 'idmall'));
    }
}
