...
class SegmentoExportSANFERNANDO implements FromView, ShouldAutoSize, WithHeadings
{
    use Exportable;
    ...
    public function view(): View
    {
        ...
        if($seleccion == 1){
            ...
            $datosSegmentoEntrada = DB::connection('mysql_2')->table('datos_seg_historicos_r1')
