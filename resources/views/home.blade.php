...
@section('content')
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-{{ !empty($camaraSectorAnterior) ? '4' : '6' }} card shadow-sm">
            ...
            <div class="col-md-{{ !empty($camaraSectorAnterior) ? '4' : '6' }} card shadow-sm aforoDiaAnterior">
                <div>
                    <div id="containerDona"></div>
                </div>
            </div>
            @if (!empty($camaraSectorAnterior))
