<div class="w-full" style="text-align: center">
    <div class="flex flex-wrap justify-between items-center mb-16">
        ...
        <div class="w-auto px-3">
            <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="id_mall">Id Mall</label>
            <input wire:model="id_mall" type="text" class="appearance-none block w-full bg-gray-200 text-gray-700 border {{ $errors->has('id_mall') ? ' border-red-500' : 'border-gray-200' }} rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500">
            @error('id_mall')
                <span class="text-red-500 text-xs italic py-1">{{ $message }}</span>
            @enderror
        </div>
