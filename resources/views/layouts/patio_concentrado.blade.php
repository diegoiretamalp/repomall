...
<head>
    ...
    <title>Monitor Mall Vivo {{$nombreMall}}</title>
...
<hr>
        <div class="border-0 pb-0">
            <div class="row align-items-center" style="">
                ...
                <h1 class="display-6 mb-0" style="text-align: center; margin-top: 25px;">Patio de comidas Mall Vivo sadasdasd</h1>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-5 card shadow-sm aforo-dia-concentrado">
                    <div class="card-body">
                        ...
                        <br>
                        @foreach ($dHoy as $item)
                            <h1 class="display-1">{{ number_format($item->Salidas, 0, ',', '.') }}</h1>
                        @endforeach
                    </div>
                </div>
            </div>
