...
@section('content')
    <div class="container" style="align-content: center">
        ...
        <div class="row">
                ...
                <div>
                    <div class="aforo-dia">
                        <div class="card-body texto-box">
                            ...
                            <br>
                            <div class="texto-ini">
                                <h1>{{ !empty($dHoy->Entradas) ? $dHoy->Entradas : 'Sin Información' }}</h1>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div id="EntradaHoy" class="col-md-6 shadow-sm chartHoy card graHoy" style="margin-top: 15px;"></div>
            <div id="EntradaCamaras" class="col-md-6 shadow-sm chartHoy card graHoy" style="margin-top: 15px;"></div>
        </div>
        <hr>
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td style="font-size: 20px;">
                                    {{ !empty($dAyer->Entradas) ? $dAyer->Entradas : 'Sin Información' }}
                            </td>
                        </tr>
                    </tbody>
                </table>
