    ...
    <div class="container">
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12">
                        <form action="{{ route('malls/nuevo.post') }}" method="post" id="formulario" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row d-flex justify-content-center">
                                <div class="col-md-4 text-center">
                                    ...
                                    <div class="form-group">
                                        <img class="bg-secondary bg-gradient" style="--bs-bg-opacity: .5;" width="200" height="200" id="logo_prev" alt="">
                                    </div>
                                </div>
                            </div>
                            ...
                            {{-- <div class="row d-flex justify-content-center">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select name="acceso_r1" id="acceso_r1" class="form-control">
                                            <option value="1">Activo</option>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select name="acceso_r2" id="acceso_r2" class="form-control">
                                            <option value="1">Activo</option>
                                            <option value="0" selected>Inactivo</option>
                                        </select>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select name="acceso_r3" id="acceso_r3" class="form-control">
                                            <option value="1">Activo</option>
                                            <option value="0" selected>Inactivo</option>
                                        </select>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group" style="display: none" id="col_nombre_r1">
                                        <label for="acceso_r1_nombre">Nombre Acceso R1</label>
                                        <input type="text" id="acceso_r1_nombre" name="acceso_r1_nombre"
                                            class="form-control" placeholder="Ingrese Nombre Acceso...">
                                        <span id="invalid_acceso_r1_nombre" class="text-danger"></span>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group" style="display: none" id="col_nombre_r2">
                                        <label for="acceso_r2_nombre">Nombre Acceso R2</label>
                                        <input type="text" id="acceso_r2_nombre" name="acceso_r2_nombre"
                                            class="form-control" placeholder="Ingrese Nombre Acceso...">
                                        <span id="invalid_acceso_r2_nombre" class="text-danger"></span>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group" style="display: none" id="col_nombre_r3">
                                        <label for="acceso_r3_nombre">Nombre Acceso R3</label>
                                        <input type="text" name="acceso_r3_nombre" id="acceso_r3_nombre"
                                            class="form-control" placeholder="Ingrese Nombre Acceso...">
                                        <span id="invalid_acceso_r3_nombre" class="text-danger"></span>
                                    </div>
                                </div>
                            </div> --}}
                                            ...
                                            <div id="collapseVehiculo" class="collapse" data-parent="#accordion">
                                                <div class="card-body">
                                                    <div class="row d-flex justify-content-center">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                <label for="acceso_tendencia">Tendencia Clientes x Vehiculos</label>
